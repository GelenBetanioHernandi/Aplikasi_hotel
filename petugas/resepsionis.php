...
<head>
  ...
  <title>Resepsionis The Royal Marin</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../template2/index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">The Royal Marin</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>RESEPSIONIS The Royal Marin</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        if (!empty(@$_GET['page'])){
          switch (@$_GET['page']) {
            case 'reservasi':
              ...
              break;
            default:
              echo "SELAMAT DATANG RESEPSIONIS The Royal Marin";
              break;
          }
        }
